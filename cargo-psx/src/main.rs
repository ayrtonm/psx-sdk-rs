...
fn extract_option(args: Vec<String>, key: &str) -> (Option<String>, Vec<String>) {
    ...
    // Gets arguments after key if any and pops the first argument after key, i.e. the
    // desired key's value. Then combines the remaining arguments with the ones before key.
