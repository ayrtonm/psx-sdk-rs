...
macro_rules! vertices_fn {
    (3) => {
        ...
        pub fn get_vertices(&self) -> [(i16, i16); 3] {
            [self.v0, self.v1, self.v2].map(|v| (v.x, v.y))
        }

        /// Sets the primitive's vertices.
        pub fn set_vertices(&mut self, vertices: [(i16, i16); 3]) -> &mut Self {
    ...
    (4) => {
        /// Gets the primitive's vertices.
        pub fn get_vertices(&self) -> [(i16, i16); 4] {
            [self.v0, self.v1, self.v2, self.v3].map(|v| (v.x, v.y))
        }

        /// Sets the primitive's vertices.
        pub fn set_vertices(&mut self, vertices: [(i16, i16); 4]) -> &mut Self {
            let vertices = vertices.map(|t| Vertex::from(t));
            self.v0 = vertices[0];
            self.v1 = vertices[1];
            self.v2 = vertices[2];
...
macro_rules! offset_fn {
    () => {
        ...
        pub fn set_offset(&mut self, offset: (i16, i16)) -> &mut Self {
...
macro_rules! size_fn {
    () => {
        ...
        /// Sets the primitive's offset.
        pub fn set_size(&mut self, size: (i16, i16)) -> &mut Self {
